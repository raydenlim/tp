...
|     GRADED_TEST      |   `gt/`    |                                                   `add` `edit`                                                    | The Graded Test score of a Student. <ul><li>Graded Tests should only contain alphanumeric characters and spaces. </li><md><li>Graded Test field should follow this format: <code>gt/RA1:0 &#124; RA2:0 &#124; MidTerms:0 &#124; Finals:0 &#124; PE:0</code></li></md></ul> |
| READING_ASSESSMENT_1 |   `ra1/`   |                                                 `editgradedtest`                                                  | The score of a Reading Assessment 1. <ul><li>Score should be a positive number.</li></ul>                                                                                                                                                                                  |
| READING_ASSESSMENT_2 |   `ra2/`   |                                                 `editgradedtest`                                                  | The score of a Reading Assessment 2. <ul><li>Score should be a positive number.</li></ul>                                                                                                                                                                                  |
...
|   **Edit Graded Test**    | `editgradedtest STUDENT_INDEX [ra1/READING_ASSESSMENT_1] [ra2/READING_ASSESSMENT_2] [mt/MIDTERMS] [f/FINALS] [pe/PRACTICAL_EXAM]` | `editgradedtest 1 ra1/90 ra2/80 mt/85 f/88 pe/95`,<br>`editgradedtest 2 ra1/88 ra2/92 mt/78 f/80 pe/89`                            |
