...
public class TaskDescriptionContainsKeywordsPredicate implements Predicate<Task> {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TaskDescriptionContainsKeywordsPredicate)) {
            return false;
        }

        TaskDescriptionContainsKeywordsPredicate otherDescContainsKeywordsPredicate =
                (TaskDescriptionContainsKeywordsPredicate) other;
        return keywords.equals(otherDescContainsKeywordsPredicate.keywords);
    }

    @Override
    public String toString() {
        return new ToStringBuilder(this).add("task desc keywords", keywords).toString();
    }
}
