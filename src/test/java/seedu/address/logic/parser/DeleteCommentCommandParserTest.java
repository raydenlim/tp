...
public class DeleteCommentCommandParserTest {
    ...
    public void parse_missingParts_failure() {
        // no index specified
        assertParseFailure(parser, ASSIGNMENT_DESC, MESSAGE_INVALID_FORMAT);
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, userInput, new DeleteCommentCommand(targetIndex, assignmentName));
    }
