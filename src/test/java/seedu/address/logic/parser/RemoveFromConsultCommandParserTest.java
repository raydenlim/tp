...
public class RemoveFromConsultCommandParserTest {
    ...
    public void parse_missingParts_failure() {
        ...
        // no field specified
        assertParseFailure(parser, "1", RemoveFromConsultCommand.MESSAGE_NOT_EDITED);
    ...
    public void parse_validName_success() {
        ...
        RemoveFromConsultCommand expectedCommand = new RemoveFromConsultCommand(targetIndex, descriptor);
